...
export default function AddToCartButton({ product, className = "" }: AddToCartButtonProps) {
  ...
  return (
    <button 
      ...
      className={`bg-black text-white font-display font-bold uppercase border-2 border-black rounded-2xl shadow-[2px_2px_0px_#000] hover:shadow-[4px_4px_0px_#000] hover:bg-white hover:text-black active:shadow-[1px_1px_0px_#000] active:translate-x-[2px] active:translate-y-[2px] transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 group-hover:bg-white group-hover:text-black disabled:opacity-80 px-6 py-4 text-sm md:text-base ${className}`}
    >
