...
const DescriptionAccordion = () => {
  ...
  return (
    <div className="bg-white border-2 border-black rounded-2xl shadow-[4px_4px_0px_#000] overflow-hidden text-base md:text-lg">
      <button 
...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fadadd]/20 flex flex-col font-sans">
      <TopNavbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-2 sm:px-6 lg:px-8  md:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col gap-6 md:gap-8 lg:sticky lg:top-24">
            ...
            {/* Add To Cart */}
             <div className="border-4 border-black p-6 md:p-8 rounded-3xl shadow-[8px_8px_0px_#000] bg-white">
              <SizeSelector />
              <div className="mt-6">
            ...
            <div className="flex justify-center gap-6 mt-2 pt-6 border-t-2 border-black/10 text-[10px] md:text-xs font-bold uppercase tracking-widest text-center text-gray-500">
              <span className="flex items-center gap-1 shadow-[2px_2px_0px_#ccc] bg-white px-2 py-1 rounded-md border-2 border-gray-200">🚀 Fast Shipping</span>
              <span className="flex items-center gap-1 shadow-[2px_2px_0px_#ccc] bg-white px-2 py-1 rounded-md border-2 border-gray-200">🛡️ Premium Quality</span>
            </div>
        ...
        <div className="mt-24 pt-12 border-t-4 border-black border-solid">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={idx} className="bg-white border-2 border-black rounded-2xl p-6 shadow-[6px_6px_0px_#000] flex flex-col gap-4">
